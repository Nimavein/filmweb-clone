...
const SeriesSeasonContentEpisode = ({
  ...
  return (
    <li className={styles["series-season-content__episodes-list-item"]}>
      <div className={styles["series-season-content__episodes-list-item-image"]}>
        {still_path ? (
          <Image
            alt=""
            width={imageWidth}
          ...
          <ImagePlaceholder height={imageHeight} width={imageWidth} type="image" />
        )}
      </div>
      <div className={styles["series-season-content__episodes-list-item-content"]}>
        ...
        {overview && (
          <p className={styles["series-season-content__episodes-list-item-overview"]}>
            {overview?.length > overviewLengthDisplay
              ? `${overview?.substring(0, overviewLengthDisplay)}...`
              : overview}
          </p>
        )}
        <Rating defaultValue={vote_average || 0} small showNumber voteCount={vote_count} />
      </div>
    </li>
  );
};
